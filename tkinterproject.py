...
class CSVproject:
    def __init__(self):
        ...
        b1=tkinter.Button(self.root,text='Add record',command=self.writerec,width=80)
        b2=tkinter.Button(self.root,text='Display record',command=self.readrec,width=80)
        b3=tkinter.Button(self.root,text='Search record',command=self.searchrec,width=80)
        b4=tkinter.Button(self.root,text='Delete record',command=self.delrec,width=80)
        b5=tkinter.Button(self.root,text='Modify record',command=self.modifyrec,width=80)
        b6=tkinter.Button(self.root,text='Exit',command=self.root.destroy,width=80)
        b1.pack()
        b2.pack()
        b3.pack()
        b4.pack()
